document.addEventListener('DOMContentLoaded', () => {
	...
	*/
	...
	function checkForMatch() {
		...
		// An if statement in the if else statement is used to determine if the same image has been clicked twice. This is achieved by checking 
